...
##### Какой флоу ? (action -> effect -> reducer)
...
Потом будет выполнено следующее действие, обычно относящееся к результирующему состоянию побочного эффекта (успех, ошибка отправки данных, и т. д.). Затем действие обрабатывает редуктор. Мы уже упоминали это в описании жизненного цикла ngrx. <br><br>
- 3.
...
##### Что такое Shadow DOM в angular?
